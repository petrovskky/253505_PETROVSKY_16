...
class Employee(models.Model):
    ...
    job = models.ForeignKey(Position, on_delete=models.CASCADE, default=1)
...
class Vacancy(models.Model):
    ...
    def __str__(self):
        return f"{self.job.title} - {self.salary}"
...
class Coupon(models.Model):
    ...
    completion = models.DateField(null=True)
...
class CompanyInfo(models.Model):
    ...
    certificate_ru_head = models.CharField(max_length=10000)
    certificate_ru_tail = models.CharField(max_length=10000)
    certificate_en_head = models.CharField(max_length=10000)
    certificate_en_tail = models.CharField(max_length=10000)
