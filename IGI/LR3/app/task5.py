...
task = '''Task: write a program for processing real lists. The program must contain the following basic functions:
...
Option 16 ==> Find the sum of non-negative elements and the product of the elements \
of the list located between the maximum and minimum absolute elements.'''

def find_sum_and_product(numbers):
    '''Calculates the sum of non-negative elements and the product of the list elements 
    located between the maximum and minimum absolute elements.'''
...
def main():
    ...
    word_divider('Task 5. Data processing')
    print_task(task)
    ...
    print('Sequence: ', ', '.join([str(number) for number in numbers]), '.', sep='', end='\n\n')
